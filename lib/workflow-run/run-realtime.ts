type WorkflowRunsRefetchListener = () => void

const listenersByWorkflowId = new Map<string, Set<WorkflowRunsRefetchListener>>()

export function subscribeWorkflowRunsRefetch(
  workflowId: string,
  listener: WorkflowRunsRefetchListener
): () => void {
...
export function notifyWorkflowRunsRefetch(workflowId?: string): void {
  if (workflowId) {
